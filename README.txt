...
jupyter app: open and run the jupyter-notebook, the app should open in another tab
type the symbol for the ticker that you want data on and click 'go'
click the figures button to compile the model and make predictions

from command line type: python predictor.py
